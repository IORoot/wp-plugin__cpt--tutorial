<div class="rounded-lg h-60 block mb-10 bg-cover" style="background-image:url('<?php echo $background_url; ?>');"  >
    <div class="w-full h-full flex flex-col bg-gradient-to-r from-black to-transparent text-white p-4 md:flex-row">
        ...
        <div class="flex-1 flex-col self-center mt-2 md:m-4 xl:m-8">
            <div class="text-xl md:text-4xl"><?php echo $term->name; ?></div>
